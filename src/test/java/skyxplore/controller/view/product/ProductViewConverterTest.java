...
import static testutil.TestUtils.ELEMENT_ID;
import static testutil.TestUtils.FACTORY_ID;
import static testutil.TestUtils.PRODUCT_ADDED_AT;
import static testutil.TestUtils.PRODUCT_AMOUNT;
import static testutil.TestUtils.PRODUCT_CONSTRUCTION_TIME;
import static testutil.TestUtils.PRODUCT_END_TIME;
import static testutil.TestUtils.PRODUCT_ID;
import static testutil.TestUtils.PRODUCT_START_TIME;
import static testutil.TestUtils.PRODUCT_END_TIME_EPOCH;
import static testutil.TestUtils.PRODUCT_START_TIME_EPOCH;
import static testutil.TestUtils.createProduct;
