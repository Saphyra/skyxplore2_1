...
public class CharacterNotInLobbyQueueFilterSettingTest {
    ...
    @InjectMocks
    private CharacterNotInLobbyQueueFilterSetting underTest;
    ...
    public void inLobby() {
        //GIVEN
        given(characterStatusQueryService.getCharacterStatus(CHARACTER_ID)).willReturn(CharacterStatus.IN_LOBBY_QUEUE);
        //WHEN
        boolean result = underTest.shouldRedirect(redirectionContext);
        //THEN
